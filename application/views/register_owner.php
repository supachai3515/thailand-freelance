...
<script>
	 ...
	 $('#chk_avail').click(function() {
			...
			$.post('<?php echo base_url(); ?>register/check_user_owner/?r='+ Math.floor(Math.random()*1000), {usr_name: name}, function(d) {
				if (d == "1") {
                ...
                $('#chk_avail_email').click(function() {
                    	...
                    	var emailRegEx = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
                      	if ((email.length >= 5)  && (emailRegEx.test(email))){
                    		$.post('<?php echo base_url(); ?>register/check_email_owner/?r='+ Math.floor(Math.random()*1000), {usr_email: email}, function(d) {
				if (d == "1") {
			...
			$('#msgbx_email_null_err').css('display', 'block');
                ...
                $('#btn-cancel').click(function() {
                  	$(location).attr('href',"<?php echo base_url(); ?>register/owner");
                });
...
<div id="register-owner-page">
		   		<div class="container">
		   			<div class="row">
		   				<div class="col-md-12">
		   					<div class="page-header" id="content-head">
		   						<h1>สมัครสมาชิก - Owner</h1>
		   						<p>กรุณากรอกข้อมูลข้างล่างให้ครบถ้วน</p>
		   					</div>
		   				</div>
		   				<div class="col-md-12">
		   					<div id="regis-form-area">
		   						<form action="<?php echo base_url(); ?>register/owner" class="form-horizontal" method="post"  enctype="multipart/form-data">
		   							...
		   							<div class="form-group">
		   								...
		   								<div class="col-sm-10">
										    ...
										    <?php echo form_error('age', '<div class="alert alert-danger contact-warning">', '</div>'); ?>
					               			 ...
					               			 <div class="form-group">
		   								<label for="" class="col-sm-2 control-label">บริษัท หรือ องค์กรผู้ว่าจ้าง</label>
		   								<div class="col-sm-10">
							...
							<?php endif; ?>
									...
									<div class="form-group">
		   								<label for="" class="col-sm-2 control-label">เว็บไซต์</label>
		   								<div class="col-sm-10">
		   							...
		   							<div class="form-group">
		   								<label for="" class="col-sm-2 control-label">ข้อมูลอื่นๆ</label>
		   								<div class="col-sm-10">
